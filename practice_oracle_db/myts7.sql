...
ALTER TABLE 강의내역 ADD CONSTRAINT PK_강의_내역번호 PRIMARY KEY (강의내역번호);
...
ALTER TABLE 수강내역 
        ...
        REFERENCES 학생(학번);
ALTER TABLE 수강내역 
        ADD CONSTRAINT FK_수강내역_과목번호 FOREIGN KEY(과목번호)
        REFERENCES 과목(과목번호);
ALTER TABLE 강의내역 
        ADD CONSTRAINT FK_강의내역_교수번호 FOREIGN KEY(교수번호)
        REFERENCES 교수(교수번호);
ALTER TABLE 강의내역 
        ADD CONSTRAINT FK_강의내역_과목번호 FOREIGN KEY(과목번호)
        REFERENCES 과목(과목번호);        
